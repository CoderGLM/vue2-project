<template>
  <footer class="flex-box--center px2">
     <a class="flex-box--center clr-cur" href="http://gengliming.com">
     ...
     <a class="flex-box--center clr-cur" href="http://gengliming.com">Desktop version</a>
   </footer>
</template>
